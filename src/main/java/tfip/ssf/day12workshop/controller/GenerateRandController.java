package tfip.ssf.day12workshop.controller;
...
import tfip.ssf.day12workshop.exception.RandNoException;
import tfip.ssf.day12workshop.model.Generate;
...
public class GenerateRandController {
    ...
    private void randomizerNum(Model m, int noOfGenerateNo){
        ...
        while(uniqueResult.size() < noOfGenerateNo){
            Integer randNumberValue = rand.nextInt(maxGenNo);
            if(randNumberValue != null){
                uniqueResult.add(randNumberValue);
            }
        }
